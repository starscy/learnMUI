...
const PhoneMenu = ({city, phoneNumber}) => {
    ...
    return (
        <Stack direction="row" className='phoneMenu' spacing={2}>
            <SvgIcon className='phoneMenu__icon'>
            ...
            <Stack>
                ...
                <Stack spacing={1} direction={'row'}>
                    <Typography fontSize={18} lineHeight={'28px'} fontWeight={700} color={'#212121'} className="phoneMenu__phone">
                        {phoneNumber}
